...
var client_references_default = {
	"205625b5a228": async () => {
		const m = await import("./assets/SiteHeader-BeSi9wqb.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"4e07333fa9b7": async () => {
		const m = await import("./assets/page-CDBiIe0A.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"6efdf509a785": async () => {
		const m = await import("./assets/page-C579m2Ro.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"78cd30ad74bf": async () => {
		const m = await import("./assets/page-CrcW691r.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"7c60f2ff7583": async () => {
		const m = await import("./assets/i18n-6dYpwIyI.js");
		return { get "I18nProvider"() {
			return m["I18nProvider"];
		} };
	},
	"9ca99391727c": async () => {
		const m = await import("./assets/SiteFooter-C4chjNZJ.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"bc8faf422085": async () => {
		const m = await import("./assets/page-29bD_m8w.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"e791668edc18": async () => {
		const m = await import("./assets/layout-segment-context-CfrAs38O.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"ffa4af8fdc37": async () => {
		const m = await import("./assets/error-boundary-XZct7fI5.js");
		return {
			get "ErrorBoundary"() {
